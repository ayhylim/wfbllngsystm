...
import { Home, Users, FileText, MessageSquare, Layout as LayoutIcon, Menu, X } from 'lucide-react';
...
export const Layout = () => {
  ...
  const NavContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-sky-200 bg-gradient-to-br from-sky-50 to-blue-50 rounded-t-2xl">
        <div className="flex items-center gap-3 p-3 bg-white rounded-xl shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">admin@wifi.com</p>
          </div>
        </div>
      </div>
    </div>
